...
A retro 3D arcade cabinet with **Protect the Forge!**, an idle tower defense game, and **Brick Breaker**, a keyboard controlled paddle game. A Bun server serves the cabinet, games, and small HTML fragments. Both games run in the browser with Canvas, while Three.js renders the cabinet.
